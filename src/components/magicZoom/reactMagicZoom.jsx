...
import './scss/_react-magic-zoom.scss';
...
class MagicZoom extends React.Component {
  ...
  getDomElement(refName, existReflection) {
    const existElement = ReactDom.findDOMNode(this.refs[refName]);
  ...
  // Pre-render methods
  getCursorFrame() {
    let cursorFrameSettings = this.state.elementsState.cursorFrame,
  ...
  render() {
    let cursorFrame = this.getCursorFrame(),
